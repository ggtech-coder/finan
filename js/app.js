...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Sidebar collapse (desktop apenas — mobile usa hamburger)
  const sidebar = document.getElementById('sidebar');
  const collapseBtn = document.getElementById('sidebarCollapseBtn');

  function setSidebarCollapsed(collapsed) {
    // Só aplica em desktop; no mobile o CSS garante que não vaza
  ...
  // Restaura estado salvo (só faz sentido em desktop)
  ...
  // Se redimensionar para mobile, limpa o estado collapsed do DOM
